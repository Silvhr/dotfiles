# Generated by Powerlevel10k configuration wizard on 2022-07-17 at 23:16 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%B%F{%(#.blue.yellow)}%n%f@%F{%(#.yellow.blue)}%m%b '
